...
static const CommandDef cmds[] = {
	...
	{ { "a"            }, (CommandFlags)CMD_TEXT,                            NULL, cmd_append        },
	{ { "c"            }, (CommandFlags)CMD_TEXT,                            NULL, cmd_change        },
	{ { "d"            }, (CommandFlags)0,                                   NULL, cmd_delete        },
	{ { "g"            }, (CommandFlags)(CMD_CMD|CMD_REGEX),                   "p",  cmd_guard         },
	{ { "i"            }, (CommandFlags)CMD_TEXT,                            NULL, cmd_insert        },
	{ { "p"            }, (CommandFlags)0,                                   NULL, cmd_print         },
	{ { "s"            }, (CommandFlags)CMD_SHELL,                           NULL, cmd_substitute    },
	{ { "v"            }, (CommandFlags)(CMD_CMD|CMD_REGEX),                   "p",  cmd_guard         },
	{ { "x"            }, (CommandFlags)(CMD_CMD|CMD_REGEX|CMD_REGEX_DEFAULT), "p",  cmd_extract       },
	{ { "y"            }, (CommandFlags)(CMD_CMD|CMD_REGEX),                   "p",  cmd_extract       },
	{ { "X"            }, (CommandFlags)(CMD_CMD|CMD_REGEX|CMD_REGEX_DEFAULT), NULL, cmd_files         },
	{ { "Y"            }, (CommandFlags)(CMD_CMD|CMD_REGEX),                   NULL, cmd_files         },
	{ { ">"            }, (CommandFlags)(CMD_SHELL|CMD_ADDRESS_LINE),          NULL, cmd_pipeout       },
	{ { "<"            }, (CommandFlags)(CMD_SHELL|CMD_ADDRESS_POS),           NULL, cmd_pipein        },
	{ { "|"            }, (CommandFlags)(CMD_SHELL|CMD_ADDRESS_POS),           NULL, cmd_filter        },
	{ { "!"            }, (CommandFlags)(CMD_SHELL|CMD_ONCE),                  NULL, cmd_launch        },
	{ { "w"            }, (CommandFlags)(CMD_ARGV|CMD_FORCE|CMD_ADDRESS_NONE|CMD_ONCE), NULL, cmd_write},
	{ { "r"            }, (CommandFlags)(CMD_FILE|CMD_ADDRESS_AFTER),          NULL, cmd_read          },
	{ { "{"            }, (CommandFlags)0,                                   NULL, NULL              },
	{ { "}"            }, (CommandFlags)0,                                   NULL, NULL              },
	{ { "e"            }, (CommandFlags)(CMD_FILE|CMD_FORCE|CMD_ONCE),         NULL, cmd_edit          },
	{ { "q"            }, (CommandFlags)(CMD_FORCE|CMD_ONCE),                  NULL, cmd_quit          },
	{ { "cd"           }, (CommandFlags)(CMD_ARGV|CMD_ONCE),                   NULL, cmd_cd            },
	/* vi(m) related commands */
	{ { "bdelete"      }, (CommandFlags)(CMD_FORCE|CMD_ONCE),                  NULL, cmd_bdelete       },
	{ { "help"         }, (CommandFlags)CMD_ONCE,                            NULL, cmd_help          },
	{ { "map"          }, (CommandFlags)(CMD_ARGV|CMD_FORCE|CMD_ONCE),         NULL, cmd_map           },
	{ { "map-window"   }, (CommandFlags)(CMD_ARGV|CMD_FORCE|CMD_ONCE),         NULL, cmd_map           },
	{ { "unmap"        }, (CommandFlags)(CMD_ARGV|CMD_ONCE),                   NULL, cmd_unmap         },
	{ { "unmap-window" }, (CommandFlags)(CMD_ARGV|CMD_ONCE),                   NULL, cmd_unmap         },
	{ { "langmap"      }, (CommandFlags)(CMD_ARGV|CMD_FORCE|CMD_ONCE),         NULL, cmd_langmap       },
	{ { "new"          }, (CommandFlags)(CMD_ARGV|CMD_ONCE),                   NULL, cmd_new           },
	{ { "open"         }, (CommandFlags)(CMD_ARGV|CMD_ONCE),                   NULL, cmd_open          },
	{ { "qall"         }, (CommandFlags)(CMD_FORCE|CMD_ONCE),                  NULL, cmd_qall          },
	{ { "set"          }, (CommandFlags)(CMD_ARGV|CMD_ONCE),                   NULL, cmd_set           },
	{ { "split"        }, (CommandFlags)(CMD_ARGV|CMD_ONCE),                   NULL, cmd_split         },
	{ { "vnew"         }, (CommandFlags)(CMD_ARGV|CMD_ONCE),                   NULL, cmd_vnew          },
	{ { "vsplit"       }, (CommandFlags)(CMD_ARGV|CMD_ONCE),                   NULL, cmd_vsplit        },
	{ { "wq"           }, (CommandFlags)(CMD_ARGV|CMD_FORCE|CMD_ADDRESS_NONE|CMD_ONCE), NULL, cmd_wq   },
	{ { "earlier"      }, (CommandFlags)(CMD_ARGV|CMD_ONCE),                   NULL, cmd_earlier_later },
	{ { "later"        }, (CommandFlags)(CMD_ARGV|CMD_ONCE),                   NULL, cmd_earlier_later },
	{ { NULL           }, (CommandFlags)0,                                   NULL, NULL              }
};
